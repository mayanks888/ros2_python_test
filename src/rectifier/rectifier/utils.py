...
def ap_per_class(tp, conf, pred_cls, target_cls):1
...
def plot_wh_methods():
    1# from utils.utils import *; plot_wh_methods()
...
def plot_test_txt():
    1# from utils.utils import *; plot_test()
...
def plot_targets_txt():
    1  # from utils.utils import *; plot_targets_txt()
    # # Plot test.txt histograms
...
def plot_results_overlay(start=0, stop=0):
    1# from utils.utils import *; plot_results_overlay()
...
def plot_results(start=0, stop=0, bucket='', id=()):
    11  # from utils.utils import *; plot_results()
